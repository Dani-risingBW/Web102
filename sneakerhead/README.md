# Web Development Project 4 - Sneakers API 
...
I am using an API that produces vulnerabilities: https://github.com/druv5319/Sneaks-API 
    I am using it only because it is safe since I am running it on a local server and controlling the inputs. Else, if I made my server open to the public then it would create a gateway to malicious viruses. 
